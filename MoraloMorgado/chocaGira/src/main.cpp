...
/** \mainpage RoboComp::chocaGira
 *
 * \section intro_sec Introduction
 *
 * The chocaGira component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/chocaGira --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
{
public:
	chocaGira (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::chocaGira::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
